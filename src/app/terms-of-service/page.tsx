        ...
        <div className="flex flex-col gap-6 max-w-4xl mx-auto px-4 py-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardSubtitle>
                        Please read these Terms of Service carefully before using our Real Estate Management Dashboard.
                    </CardSubtitle>
                </CardHeader>
                <CardBody>
                    <div className="space-y-6">
                        <section className="pb-6 border-b border-gray-200">
                            ...
                            <p className="mb-2">
                                By accessing or using our Real Estate Management Dashboard, you agree to be bound by these Terms of
                                Service and our Privacy Policy. If you disagree with any part of the terms, you may not access the
                                service.
                            </p>
                        </section>
                        ...
                        <section className="py-6 border-b border-gray-200">
                            ...
                            <p className="mb-2">
                                The Real Estate Management Dashboard is a platform designed to help property managers and owners manage
                                their real estate portfolios, including properties, tenants, and payments.
                            </p>
                            <p className="mb-2">
                        ...
                        <section className="py-6 border-b border-gray-200">
                            ...
                            <p className="mb-2">
                                To use certain features of our service, you must register for an account. You must provide accurate,
                        ...
                        <section className="pt-6">
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>By mail: <p className="text-gray-600">123 Real Estate Avenue</p>
                                    <p className="text-gray-600">New York, NY 10001</p></li>
                            </ul>
                        </section>
                    </div>
                </CardBody>
